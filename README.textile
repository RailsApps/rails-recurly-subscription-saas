...
Best of all, there's a "detailed tutorial":http://railsapps.github.com/tutorial-rails-recurly-subscription-saas.html to show how it's built.
...
h4. "View the Tutorial":http://railsapps.github.com/tutorial-rails-recurly-subscription-saas.html
...
question  Install an example application?
      ...
      2)  rails-recurly-subscription-saas
...
Choose *rails-recurly-subscription-saas*. The Rails Composer tool may give you other options (other choices may have been added since these notes were written).
...
Alternatively, you can set Heroku environment variables for your Recurly credentials like this:

<pre>
$ heroku config:add RECURLY_API_KEY=secret RECURLY_JS_PRIVATE_KEY=secret RECURLY_SUBDOMAIN=mydomain
</pre>

Optionally, you can change your *db/seeds.rb* file before deployment. You may wish to remove the "example.com" sample users. Optionally, you can change the administrator name, email and password though it is better to wait and change the values through the application "Edit account" interface later.
...
The "tutorial":http://railsapps.github.com/tutorial-rails-recurly-subscription-saas.html provides additional documentation.
